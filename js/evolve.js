...
function toggle() {
  ...
  $(".opentoge").click(function () {
    ...
    if ($("#spec").hasClass("active")) {
      $(this).css({
        "background-image":
          "url('https://kangjeongdo.github.io/evolve/images/bul_remove.svg')",
      });
    } else {
      $(this).css({
        "background-image":
          "url('https://kangjeongdo.github.io/evolve/images/bul_add.svg')",
      });
    }
  });
...
function cardBg() {
  $(
    ".deliveryInfo #pContainer #page2 fieldset > div:first-child > input:first-of-type"
  ).keyup(function () {
    ...
    switch (cardNum) {
      case "4":
        card.css(
          "background-image",
          "url('https://kangjeongdo.github.io/evolve/images/pic_visacard.svg')"
        );
        break;
      case "5":
        card.css(
          "background-image",
          "url('https://kangjeongdo.github.io/evolve/images/pic_master.svg')"
        );
        break;
      default:
        card.css(
          "background-image",
          "url('https://kangjeongdo.github.io/evolve/images/pic_american.svg')"
        );
        break;
    }
  });
...
function log() {
  ...
  $("#loginContainer [id$='Container'] > div:first-of-type > .openEmail").click(
    function () {
  ...
  $("#loginContainer > #lContainer > #leContainer .openStep").click(
    function () {
      var block = "#" + $(this).attr("data-step");
  ...
  $(".openBtn").click(function () {
    ...
    if (block != "cartpaenl") {
      ...
      $("#loginContainer > [id$='Container'] > div:last-of-type").removeClass(
        "active"
      );
      $("#loginContainer > #sContainer").addClass("active");
      $("#loginContainer > [id$='Container'] > div:first-of-type").addClass(
        "active"
      );
    }
  });
